...
VALUES
 ('admin@mail.com', 'admin', 'admin1'),
 ('user@mail.com', 'user', 'user1'),
 ('anton@mail.com', 'anton', 'anton1'),
 ('travis@mail.com', 'travis', 'travis1'),
 ('sunford@mail.com', 'sunford', 'sunford1'),
 ('headhunter@mail.com', 'headhunter', 'headhunter1');
...
VALUES
 ('pianoforte', 'really so rapturous ask offering ago they you against get great my his in Own supposing an in', 2),
 ('Sportsman', 'Projecting trifling led compliment call had she shortly thus now', 3),
 ('Apartments', 'do of above him during his fine middletons it that over', 4),
 ('Compact', ' Am has So new wondered wife views easily agreement entreaties ', 5),
 ('Express', 'Mrs september The mr be mile more face as begin they come moment remove her we on all Visited', 6);

INSERT INTO Channels (name, description, trusted, owner)
VALUES
 ('Travelling ', 'As possession attacks produce style sigh attention nor ', true, 4),
 ('Possession ', 'not exeter must merits society world. Weddings dare gave ask above', true, 5),
 ('Pronounce ', 'Arrival message front very life left not certainty sing husband over. Shall delight next day hill say law friendly noise merit. ', true, 6);

INSERT INTO Topics (title, description)
VALUES
 ('Recurred ', 'Welcome to the website. If youre here, youre likely looking to find random words. '),
 ('Agreeable ', 'Leaf marianne genius every period table appetite sportsman compact of estimable mrs gave easily unpacked went.'),
 ('Consulted ', 'Told keeps latter away whole because laughing loud means esteem address.'),
 ('Articles', 'True me shyness happen attachment sweetness juvenile disposed breeding without body. '),
 ('Library', 'ability stairs hunted took real looked. ');
