...
<header class="px-2">
    <nav class="navbar navbar-light bg-light">
        <div class="container-fluid">
            ...
            <a class="navbar-brand">Akhyamov 211-321</a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="./backend/add_message_post.php">
...
<div class="mt-7 ps-3 container">
    ...
    $messages = getMessages($_SESSION['username'], $_POST['channel'], $_POST['tag'], $_POST['topic']);
    if (!$messages) {
        return 0;
    }
